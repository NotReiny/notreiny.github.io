    ...
    (function (e, n) {
        ...
        function (e) {
            ...
            function ie(e) {
                var t, r, a = n;
                if (e) {
                    re.style.display = "flex"; // (const re at line 228)
                    var o = (t = Ce.x,
                        r = Ce.y,
                    {
            ...
            function ce() {
                var e = n
                    , t = 0;
                return ae.bold.enabled && (t += 8), // (const ae at line 233)
            ...
            var he, ye, ge, pe = 0, be = Yr(se[pe], .6), xe = false, we = new Map, Me = [], ke = [], Ee = new Map, Se = new Worker("/static/ping.js"), Ie = false, Ce = {
                x: 0,
                y: 0,
                rawx: 0,
                rawy: 0,
